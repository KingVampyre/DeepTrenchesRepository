...
@ObjectHolder(MODID)
public class ModTaxonomyRanks {

    public static final Rank BARBELED_LOOSEJAW = null;
    public static final Rank BETTA = null;
    public static final Rank BLACK_LOOSEJAW = null;
