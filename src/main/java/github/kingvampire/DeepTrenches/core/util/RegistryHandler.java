...
public class RegistryHandler {
	...
	public static void registerEntities(Register<EntityType<?>> event) {
		...
		EntityType<AdaiggerEntity> adaigger = EntityType.Builder.<AdaiggerEntity>create(AdaiggerEntity::new, MISC)
				.size(0.5F, 0.5F).setCustomClientFactory(AdaiggerEntity::new).build(MODID + ".adaigger");
