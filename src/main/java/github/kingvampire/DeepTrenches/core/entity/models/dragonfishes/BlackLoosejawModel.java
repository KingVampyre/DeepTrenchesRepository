...
@OnlyIn(Dist.CLIENT)
public class BlackLoosejawModel<T extends Entity> extends EntityModel<T> {
	...
	this.setRotateAngle(Lower_jaw, 0.27314402793711257F, 0.0F, 0.0F);
	...
	this.Upper_Jaw.setRotationPoint(0.0F, 2.5F, 2.0F);
