...
import github.kingvampire.DeepTrenches.core.entity.goals.stasp.AngerGoal;
...
import github.kingvampire.DeepTrenches.core.entity.goals.stasp.StaspAttackGoal;
...
public class StaspEntity extends CreatureEntity {
	...
	private static final DataParameter<Integer> ANGER = EntityDataManager.createKey(StaspEntity.class, VARINT);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(0, new StaspAttackGoal(this, 0.2F, false));
