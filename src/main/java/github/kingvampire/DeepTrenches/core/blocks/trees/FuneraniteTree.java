...
import static github.kingvampire.DeepTrenches.core.init.ModBlocks.FUNERANITE_SAPLING;
...
import github.kingvampire.DeepTrenches.core.world.gen.fungus.FuneraniteFungusFeature;
import net.minecraft.block.Block;
import net.minecraft.util.Direction;
import net.minecraft.world.gen.feature.AbstractTreeFeature;
import net.minecraft.world.gen.feature.NoFeatureConfig;

public class FuneraniteTree extends ModThickTree {
	...
	protected TemplateTreeFeature getThickTreeFeature(Random random) {
		...
		return new FuneraniteFungusFeature(direction, this);
	}
