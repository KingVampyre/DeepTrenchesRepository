...
import github.kingvampire.DeepTrenches.api.world.gen.processors.LeavesProcessor;
...
public class TemplateTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public static final StructureProcessor LEAVES = new LeavesProcessor();
	...
	return settings.addProcessor(AIR).addProcessor(LEAVES);
    }
